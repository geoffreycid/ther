...
def mission_tokenizer(dict_env, target):
    ...
    mission_seniority_onehot[dict_env["TYPE_TO_IDX"][target["type"]]] = 1

    return torch.cat((mission_type_onehot, mission_color_onehot, mission_seniority_onehot)).unsqueeze(0)
