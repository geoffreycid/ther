...
def training(dict_env, dict_agent, dict_expert):
    ...
    dict_env_evaluate = json.loads(config_env)
    ...
    while True:
        ...
        for t in range(T_MAX):
            ...
            if steps_done % dict_env["smoothing"] == 0:
                ...
                # Evaluate on unseen instructions
                evaluate.evaluate(dict_env_evaluate, dict_agent, policy_net, net_expert, writer, steps_done)
